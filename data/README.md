...
VGGTが出すcamera，depth，3D点，追跡結果の相互整合性を，同じsensor noise模様を反復する入力と，毎回異なるnoise模様を使う入力で比較した集計である．TartanAirの4画像系列，撮影位置2水準，noise条件2水準，3 seedからなる48回の推論を含む．JSONには対応づけた条件差，既知答えcontrol，正解上で可視な点だけに限定した追加監査，撮影位置構成の事後比較を保存する．NPZには定性的な実例に用いる縮小画像と四つの予測位置だけを保存し，元のTartanAir画像，depth，model checkpointは含まない．
