...
> 2026-07-15のtheme-searchで得た仮説と実験計画である．実験結果ではない．
...
現在は，先行研究と区別できる出力形式は残っているが，予備結果がなく，条件を揃えた比較の実装負荷も高い．したがって，独立テーマとして着手せず，次の実験候補として保存する．
...
最終3Dは同じで，初期整合性や数値条件だけが変わる場合は，最適化挙動のcharacterizationへ縮小して再評価する．人工的な診断条件だけが良い場合は前進させない．
...
この仮説は，同一構成の先行研究が見つからず，反証可能な比較も定義できるため，研究上の問いとしては残る．一方，予備結果がなく，座標との情報等価性が強い反証候補であり，最初の実装も軽いtoyでは済まない．

成功すれば主要国際会議で強い評価を狙えるが，一つの条件を揃えた比較だけではoralへ届かない．幅広い画像枚数，overlap，indoor/outdoor，repeated structureへの一般化と，実際の3D pipelineを変える実用上の帰結が別に必要だからである．

したがって，現時点では新しい独立projectを作らず，このIssueを実験候補として保存する．着手する場合は，図2の条件を揃えた比較だけを先に行い，人工的なscene混合や大規模な拡張は結果が出るまで作らない．
