...
|---|---|---|
| **P3** | 同じsceneに対する既存のPi3点群 | 厳密なground truthではなく，geometry評価のpseudo-reference |
...
各画像は，9個のvisual armを匿名化した状態でfront/back/left/right/top/bottomから描画したcontact sheetである．RGB画像はpoint color，source画像はpointを生成したwindowを色分けしている．source画像で異なる色のroom surfaceが平行に反復する場合，同じ壁・床がwindowごとに別位置へ置かれていることを表す．

匿名化対応は次の通りである．A2oとA6は点群がなく，図には含まれない．

| Scene | A0-all | A0-ellipsoids | A1 | A2n | A3 | A4 | A4F | A5 | ATLAS |
|---|---|---|---|---|---|---|---|---|---|
| bathroom | Arm-04 | Arm-03 | Arm-09 | Arm-06 | Arm-01 | Arm-02 | Arm-05 | Arm-08 | Arm-07 |
| bedroom-1 | Arm-09 | Arm-03 | Arm-07 | Arm-06 | Arm-05 | Arm-04 | Arm-01 | Arm-02 | Arm-08 |
| living room | Arm-05 | Arm-09 | Arm-07 | Arm-02 | Arm-01 | Arm-06 | Arm-08 | Arm-03 | Arm-04 |
| bedroom-2 | Arm-01 | Arm-05 | Arm-06 | Arm-03 | Arm-08 | Arm-09 | Arm-04 | Arm-02 | Arm-07 |

### Bathroom

![BathroomのRGB点群比較](https://github.com/KohsukeIde/e2e-3d-notes/blob/main/figures/t24_erayzer_scene_pc/scene-001-bathroom-rgb.jpg?raw=1)

*A3/A4/A4F/A5/ATLASでは，roomがtrajectory方向へ複数のbandとして分離し，同じ壁面が平行に反復している．compactなArm-03/04はA0のone-shot OOD baselineであり，multi-window fusionの成功例ではない．*

<details>
<summary>Bathroom：source-window色でwindow分離を見る</summary>

![Bathroomのsource-window比較](https://github.com/KohsukeIde/e2e-3d-notes/blob/main/figures/t24_erayzer_scene_pc/scene-001-bathroom-source.jpg?raw=1)

</details>

### Bedroom-1

![Bedroom-1のRGB点群比較](https://github.com/KohsukeIde/e2e-3d-notes/blob/main/figures/t24_erayzer_scene_pc/scene-002-bedroom-rgb.jpg?raw=1)

*A3/A4/A4F/A5/ATLASは，複数のroom copyまたは強い平行wall layerを残す．見かけ上connectedな方法でも，source-window色では異なるwindowのsurfaceが重なっている．*

<details>
<summary>Bedroom-1：source-window色でwindow分離を見る</summary>

![Bedroom-1のsource-window比較](https://github.com/KohsukeIde/e2e-3d-notes/blob/main/figures/t24_erayzer_scene_pc/scene-002-bedroom-source.jpg?raw=1)

</details>

### Living room

![Living roomのRGB点群比較](https://github.com/KohsukeIde/e2e-3d-notes/blob/main/figures/t24_erayzer_scene_pc/scene-003-living-room-rgb.jpg?raw=1)

*大域的なextentは一つに見える方法でも，壁・家具のcopyとsource-window seamが残る．global graphやray re-anchoringでghosted surfaceは消えていない．*

<details>
<summary>Living room：source-window色でwindow分離を見る</summary>

![Living roomのsource-window比較](https://github.com/KohsukeIde/e2e-3d-notes/blob/main/figures/t24_erayzer_scene_pc/scene-003-living-room-source.jpg?raw=1)

</details>

### Bedroom-2

![Bedroom-2のRGB点群比較](https://github.com/KohsukeIde/e2e-3d-notes/blob/main/figures/t24_erayzer_scene_pc/scene-004-bedroom-rgb.jpg?raw=1)

*A5はF@5を少し改善したが，source-windowごとのwall layerが残り，thicknessも悪化した．数値の一部改善がcoherent scene cloudを意味しない例である．*

<details>
<summary>Bedroom-2：source-window色でwindow分離を見る</summary>

![Bedroom-2のsource-window比較](https://github.com/KohsukeIde/e2e-3d-notes/blob/main/figures/t24_erayzer_scene_pc/scene-004-bedroom-source.jpg?raw=1)

</details>

blind reviewでは，4 sceneすべてでA3/A4/A4F/A5/ATLASにgross window split，またはrepeated/ghosted room surfaceが確認された．したがって，定量指標だけでなく見た目でもcleanなmulti-window scene cloudはない．
